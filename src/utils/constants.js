...
constants['RESOURCES_ALL'] = [
  constants.RESOURCE_ENERGY,
  constants.RESOURCE_POWER,

  constants.RESOURCE_HYDROGEN,
  constants.RESOURCE_OXYGEN,
  constants.RESOURCE_UTRIUM,
  constants.RESOURCE_KEANIUM,
  constants.RESOURCE_LEMERGIUM,
  constants.RESOURCE_ZYNTHIUM,
  constants.RESOURCE_CATALYST,
  constants.RESOURCE_GHODIUM,

  constants.RESOURCE_HYDROXIDE,
  constants.RESOURCE_ZYNTHIUM_KEANITE,
  constants.RESOURCE_UTRIUM_LEMERGITE,

  constants.RESOURCE_UTRIUM_HYDRIDE,
  constants.RESOURCE_UTRIUM_OXIDE,
  constants.RESOURCE_KEANIUM_HYDRIDE,
  constants.RESOURCE_KEANIUM_OXIDE,
  constants.RESOURCE_LEMERGIUM_HYDRIDE,
  constants.RESOURCE_LEMERGIUM_OXIDE,
  constants.RESOURCE_ZYNTHIUM_HYDRIDE,
  constants.RESOURCE_ZYNTHIUM_OXIDE,
  constants.RESOURCE_GHODIUM_HYDRIDE,
  constants.RESOURCE_GHODIUM_OXIDE,

  constants.RESOURCE_UTRIUM_ACID,
  constants.RESOURCE_UTRIUM_ALKALIDE,
  constants.RESOURCE_KEANIUM_ACID,
  constants.RESOURCE_KEANIUM_ALKALIDE,
  constants.RESOURCE_LEMERGIUM_ACID,
  constants.RESOURCE_LEMERGIUM_ALKALIDE,
  constants.RESOURCE_ZYNTHIUM_ACID,
  constants.RESOURCE_ZYNTHIUM_ALKALIDE,
  constants.RESOURCE_GHODIUM_ACID,
  constants.RESOURCE_GHODIUM_ALKALIDE,

  constants.RESOURCE_CATALYZED_UTRIUM_ACID,
  constants.RESOURCE_CATALYZED_UTRIUM_ALKALIDE,
  constants.RESOURCE_CATALYZED_KEANIUM_ACID,
  constants.RESOURCE_CATALYZED_KEANIUM_ALKALIDE,
  constants.RESOURCE_CATALYZED_LEMERGIUM_ACID,
  constants.RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE,
  constants.RESOURCE_CATALYZED_ZYNTHIUM_ACID,
  constants.RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE,
  constants.RESOURCE_CATALYZED_GHODIUM_ACID,
  constants.RESOURCE_CATALYZED_GHODIUM_ALKALIDE
];

constants['COLORS_ALL'] = [
  constants.COLOR_RED,
